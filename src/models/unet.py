...
class UNet(nn.Module):
    ...
    def forward(self, x, t, c=None, s=None):
        ...
        Args:
            ...
            c (torch.Tensor, optional): Class embedding tensor. Defaults to None.
            s (torch.Tensor, optional): Second time step tensor for additional noise level. Defaults to None.

        Returns:
            torch.Tensor: Output tensor after passing through the UNet model.
        """
